...
2. **Updated `.claude/skills/template-scaffolding/SKILL.md`**
...
3. **Updated `.claude/skills/template-validator/SKILL.md`**
...
```bash
# For each template:
.claude/scripts/templates/check-integrity.sh templates/{template-name}
```
...
1. Create automated integrity check script (`.claude/scripts/templates/check-integrity.sh`)
...
- `.claude/skills/template-scaffolding/SKILL.md` - Template creation guidelines
- `.claude/skills/template-validator/SKILL.md` - Template validation procedures
