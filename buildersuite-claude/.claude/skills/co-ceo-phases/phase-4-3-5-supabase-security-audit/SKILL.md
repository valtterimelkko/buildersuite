...
TASK:
1) Run ./.claude/scripts/supabase/security-audit.sh
...
- [ ] `.claude/scripts/supabase/security-audit.sh` executed
...
```bash
.claude/scripts/co-ceo/git-commit-phase.sh "4.3.5" "Supabase security audit complete"
```

## Verify

```bash
.claude/scripts/co-ceo/verify-phase-completion.sh 4.3.5
```
