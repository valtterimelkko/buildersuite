...
```bash
python3 .claude/scripts/stripe/lookup_pattern.py --pattern "PATTERN_NAME"
```

### List All Available Patterns

```bash
python3 .claude/scripts/stripe/lookup_pattern.py --list
```

### Search Patterns by Keyword

```bash
python3 .claude/scripts/stripe/lookup_pattern.py --search "KEYWORD"
```
...
```bash
python3 .claude/scripts/stripe/lookup_pattern.py --pattern "webhook-handler"
```
...
```bash
python3 .claude/scripts/stripe/lookup_pattern.py --pattern "meters-api"
```
...
```bash
python3 .claude/scripts/stripe/lookup_pattern.py --search "trial"
```
...
1. **Extend webhook handlers:**
   ```bash
   python3 .claude/scripts/stripe/lookup_pattern.py --pattern "dunning-handler"
   ```

2. **Add Customer Portal:**
   ```bash
   python3 .claude/scripts/stripe/lookup_pattern.py --pattern "customer-portal"
   ```
