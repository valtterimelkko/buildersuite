...
slimmed-strategic-co-ceo-process.md (entry point)
    ↓
Phase Skills (.claude/skills/co-ceo-phases/)
    ↓
...
**Use the `writing-skills` skill** before creating any skill.
...
#### 3. Helper Scripts (`.claude/scripts/<category>/<name>.sh`)
...
3. Create phase skill in `.claude/skills/co-ceo-phases/phase-X-Y-name/`
