...
```bash
.claude/scripts/co-ceo/check-infrastructure-prerequisites.sh
```
...
# Check only Stripe
.claude/scripts/co-ceo/check-infrastructure-prerequisites.sh --stripe

# Check only Supabase
.claude/scripts/co-ceo/check-infrastructure-prerequisites.sh --supabase

# JSON output for programmatic use
.claude/scripts/co-ceo/check-infrastructure-prerequisites.sh --json

# Individual connection tests
python3 .claude/scripts/stripe/test_connection.py --all
python3 .claude/scripts/supabase/test_connection.py --all
```

## Verify Before Proceeding

```bash
.claude/scripts/co-ceo/verify-phase-completion.sh 4.2.5
```
