...
```bash
python3 .claude/scripts/stripe/generate_fixtures.py --template "analytics-dashboard"
```

### Generate with Custom Output Path

```bash
python3 .claude/scripts/stripe/generate_fixtures.py --template "productivity-tool" --output "tests/stripe-fixtures.json"
```

### Generate All Template Fixtures

```bash
python3 .claude/scripts/stripe/generate_fixtures.py --all
```
