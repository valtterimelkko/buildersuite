...
ls -la .claude/scripts/benchmarking/scrape_results/
```

**Required inputs:**
- [ ] `SaaS_Frontend_Template_Research.md` — UI patterns, components, design systems (417 lines)
- [ ] `.claude/scripts/benchmarking/scrape_results/` — HTML captures and screenshots
...
**Reference Materials:**
- Research: `.claude/scripts/benchmarking/4th_template/` (ProductMotion, CloudConvert)
...
**Reference Materials:**
- Research: `.claude/scripts/benchmarking/4th_template/` (minimal download/store flows)
...
cat .claude/scripts/benchmarking/scrape_results/notion/notion_*.html
```
...
- `.claude/scripts/benchmarking/scrape_results/` (visual reference)
- `.claude/scripts/benchmarking/4th_template/` (minimal SaaS benchmarking for utility + download)
