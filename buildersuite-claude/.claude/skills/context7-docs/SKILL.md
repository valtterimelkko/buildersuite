...
**For Claude Code Web:**
Add to your Claude Code settings or environment configuration:
```
...
```bash
python3 ~/.claude/scripts/context7/fetch_docs.py --library "owner/repo"
```

### Fetch Topic-Focused Documentation

```bash
python3 ~/.claude/scripts/context7/fetch_docs.py --library "owner/repo" --topic "TOPIC"
```

### Fetch Documentation Info (Instead of Code)

```bash
python3 ~/.claude/scripts/context7/fetch_docs.py --library "owner/repo" --type info
```

### Fetch Specific Version

```bash
python3 ~/.claude/scripts/context7/fetch_docs.py --library "owner/repo" --version "v15.1.8"
```
...
```bash
python3 ~/.claude/scripts/context7/fetch_docs.py \
...
1. Search for library (if ID unknown):
   python3 ~/.claude/scripts/context7/resolve_library.py --query "supabase"
...
- **Claude Code Web**: Verify the environment variable is set in your settings
