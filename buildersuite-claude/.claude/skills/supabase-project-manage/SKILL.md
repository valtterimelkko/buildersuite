...
```bash
# Basic info
python3 ~/.claude/scripts/supabase/get_project.py --ref "abcdefghij"

# Include API keys
python3 ~/.claude/scripts/supabase/get_project.py --ref "abcdefghij" --include-keys
```
...
```bash
python3 ~/.claude/scripts/supabase/get_connection_string.py --ref "abcdefghij"
```
...
python3 ~/.claude/scripts/supabase/delete_project.py --ref "abcdefghij"

# Actually delete
python3 ~/.claude/scripts/supabase/delete_project.py --ref "abcdefghij" --confirm
```
