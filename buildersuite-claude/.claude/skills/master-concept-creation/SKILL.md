...
```bash
.claude/scripts/master-concept/validate-concept.sh --generate-template docs/concept/master-concept.md
```
...
Location: `.claude/scripts/master-concept/validate-concept.sh`
...
See `.claude/skills/master-concept-creation/examples/` for complete, realistic Master Concept examples:
