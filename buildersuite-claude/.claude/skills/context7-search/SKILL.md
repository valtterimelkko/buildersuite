...
```bash
python3 ~/.claude/scripts/context7/resolve_library.py --query "LIBRARY_NAME"
```

### Limit Results

```bash
python3 ~/.claude/scripts/context7/resolve_library.py --query "LIBRARY_NAME" --limit 5
```
...
```bash
# Search for Next.js
python3 ~/.claude/scripts/context7/resolve_library.py --query "next.js"

# Search for Prisma
python3 ~/.claude/scripts/context7/resolve_library.py --query "prisma" --limit 5

# Search for MongoDB driver
python3 ~/.claude/scripts/context7/resolve_library.py --query "mongodb"
```
...
- **Claude Code Web**: Verify the `CONTEXT7_API_KEY` environment variable is set in your settings
