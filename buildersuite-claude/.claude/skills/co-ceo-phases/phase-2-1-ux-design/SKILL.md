...
description: Co-CEO Phase 2.1 - Launch UX Designer agent to create detailed user flows, screen specifications, and interaction design.
---
...
```bash
.claude/scripts/co-ceo/git-commit-phase.sh "2.1" "MVP User Experience design completed"
```
...
```bash
.claude/scripts/co-ceo/verify-phase-completion.sh 2.1
```
