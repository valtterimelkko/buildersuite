...
**Validation script:**
```bash
python3 .claude/scripts/templates/check-brand-tokens.py templates/{template}
```
...
Location: `.claude/scripts/templates/apply-brand-tokens.py`

**Usage:**
```bash
python3 .claude/scripts/templates/apply-brand-tokens.py \
