...
**Important:** When the Co-CEO runs in VS Code Claude Code extension, all spawned agents share the same working directory. This fundamentally limits parallelization:
