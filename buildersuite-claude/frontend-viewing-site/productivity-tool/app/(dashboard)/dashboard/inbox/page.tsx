...
export default async function InboxPage() {
  ...
  const unreadNotifications = notifications?.filter((n: { read_at: string | null }) => !n.read_at) || []
  const readNotifications = notifications?.filter((n: { read_at: string | null }) => n.read_at) || []
          ...
          <div className="divide-y divide-border">
            ...
            {unreadNotifications.length > 0 && (
              <>
                ...
                {unreadNotifications.map((notification: { id: string; type: string; actor?: { display_name?: string }; issue?: { identifier: string; title: string }; preview?: string; created_at: string }) => (
                  <NotificationItem
                    key={notification.id}
            ...
            {readNotifications.length > 0 && (
              <>
                ...
                {readNotifications.map((notification: { id: string; type: string; actor?: { display_name?: string }; issue?: { identifier: string; title: string }; preview?: string; created_at: string }) => (
                  <NotificationItem
                    key={notification.id}
                    notification={notification}
                    isUnread={false}
