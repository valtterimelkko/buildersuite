...
python3 ~/.claude/scripts/supabase/list_tables.py --ref "abcdefghij"

# List tables in specific schema
python3 ~/.claude/scripts/supabase/list_tables.py --ref "abcdefghij" --schema "auth"

# Get columns for a table
python3 ~/.claude/scripts/supabase/list_tables.py --ref "abcdefghij" --table "profiles"
```
...
```bash
# Insert single row
python3 ~/.claude/scripts/supabase/mutate_table.py \
    --ref "abcdefghij" \
    --table "posts" \
...
```bash
# Enable RLS on table
python3 ~/.claude/scripts/supabase/manage_rls.py \
    --ref "abcdefghij" \
    --table "posts" \
    --enable
