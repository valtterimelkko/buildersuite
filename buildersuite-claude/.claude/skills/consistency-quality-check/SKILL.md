...
**Master Concept:**
```bash
.claude/scripts/master-concept/validate-concept.sh docs/concept/master-concept.md
```
...
```bash
python3 .claude/scripts/api-validation/validate-api-contracts.py --prd docs/Project-Technical-Architecture.md --frontend src/
```
...
**Location:** `.claude/scripts/consistency-check/`
...
.claude/scripts/consistency-check/cross-reference-check.sh --json docs/

# Quiet mode - only show errors
.claude/scripts/consistency-check/validate-document-structure.sh --quiet docs/
```
...
**Location:** `.claude/scripts/api-validation/`
...
python3 .claude/scripts/api-validation/validate-api-contracts.py \
...
```bash
chmod +x .claude/scripts/consistency-check/*.sh
chmod +x .claude/scripts/api-validation/*.py
```
